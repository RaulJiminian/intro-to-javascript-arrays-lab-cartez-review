...
let soyIdx= foods2.indexOf("tofu")
...
let hasSoup= foods2.includes("soup")
...
const numArrays = [
	[100, 5, 23],[15, 21, 72, 9],[45, 66],[7, 81, 90]     //this is called a nested array
];
...
const numArrays3 = [[100, 5, 23],[15, 21, 72, 9],[45, 66],[7, 81, 90]];
    
let total =0;
numArrays3.forEach(internalarray => {
    internalarray.forEach(number => 
        {total += number;
    });
});
